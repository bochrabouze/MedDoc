                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="firstname" type="text" class="form-control" v-model="firstname" required
                                           autofocus autocomplete="off"  placeholder="Enter your  first name">
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="phone" type="text" class="form-control" v-model="phone" required
                                           autofocus autocomplete="off"  placeholder="Enter your phone number">
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="address" type="text" class="form-control" v-model="address" required
                                           autofocus autocomplete="off"  placeholder="Enter your address">
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="speciality" class="col-sm-4 col-form-label text-md-right">Speciality</label>
                                <div class="col-md-8">
                                    <input id="speciality" type="text" class="form-control" v-model="speciality" required
                                           autofocus autocomplete="off"  placeholder="Enter your speciality">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-1">
                                ...
                                <div class="col-md-8">
                                    <input id="email" type="email"  class="form-control" v-model="email" required
                                           autofocus autocomplete="off"   placeholder="Enter your E-Mail Address">
